...
let fire1 = WEvent.fire_event newswire h1 ;;
let fire2 = WEvent.fire_event newswire h2 ;;
let fire3 = WEvent.fire_event newswire h3 ;;
...
let receive_report (s : string) =
  ignore (WEvent.add_listener publish (fun () -> WEvent.fire_event newswire s)) ;;
...
let fire4 = WEvent.fire_event newswire h4 ;;
let fire5 = WEvent.fire_event newswire h5 ;;
let fire6 = WEvent.fire_event newswire h6 ;;
...
WEvent.fire_event publish fire4 ;;
